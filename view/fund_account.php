...
<div id="deposit" class="displays">
    ...
    <div class="fund_account" style="width:70%; margin:5px 0;">
            ...
            <section class="addUserForm">
                <div class="inputs" style="flex-wrap:wrap">
                    ...
                    <div class="data" style="width:100%; margin:5px 0">
                        ...
                        <textarea name="details" id="details" cols="30" rows="5" placeholder="Enter a detailed description of the transaction">Being Deposit</textarea>
                    </div>
                    <div class="data" style="width:50%; margin:5px 0">
