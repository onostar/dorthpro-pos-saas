...
<div class="dashboard_all">
    ...
    <?php 
        if($role === "Admin" || $role === "Accountant"){
            ...
            $store_id = $get_store->fetch_details_group('stores', 'store_id', 'store', $store);
            if(gettype($store_id) == "object"){
            ...
            <a href="javascript:void(0)" class="page_navs">
                <div class="infos">
                    ...
                    <?php
                        //get total sales
                        $get_sales = new selects();
                        $rows = $get_sales->fetch_sum_curdate2Con('sales', 'total_amount', 'post_date', 'store', $store_id, 'sales_status', 2);
                        foreach($rows as $row){
                            $sales = $row->total;
                        }
                        //get cost of sales
