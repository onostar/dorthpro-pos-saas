...
?>
<div id="printReceipt" class="displays management" style="margin:0!Important">
    <div class="select_date" style="width:100%;">
        <!-- <form method="POST"> -->
        <section>    
            <div class="from_to_date" style="width:25%">
    ...
    <table id="revenue_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a style="color:green; background:var(--otherColor); padding:5px; border-radius:10px; box-shadow:1px 1px 1px #222;color:#fff" href="javascript:void(0)" title="View invoice details" onclick="showPage('print_transfer_details.php?invoice=<?php echo $detail->invoice?>')"> <i class="fas fa-eye"></i> View</a>
                    <button style="box-shadow:none;border-radius:10px; background:#c4c4c4; color:#000; padding:5px;box-shadow:1px 1px 1px #222" title="Print receipt" onclick="printTransferReceipt('<?php echo $detail->invoice?>');"><i class="fas fa-print"></i> Print</button>
                </td>
            </tr>
            <?php $n++; endforeach;}?>
        </tbody>
