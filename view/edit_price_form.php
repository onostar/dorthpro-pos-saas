...
<?php
    ...
    $rows = $get_item->fetch_details_cond('items', 'item_id', $item);
     if(gettype($rows) == 'array'){
        foreach($rows as $row):
?>
    <div class="add_user_form priceForm" style="width:90%">
        ...
        <section class="addUserForm" style="text-align:left;">
            <div class="inputs" style="flex-wrap:wrap; gap:.5rem; justify-content:left">
                ...
                <div class="data" style="width:24%">
                    ...
                    <input type="text" name="discount" id="discount" value="<?php echo $row->markup?>">
                </div>
               <!--<div class="data" style="width:24%">
