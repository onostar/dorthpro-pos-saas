...
<div class="displays allResults sales_receipt">
    ...
    <?php
        ...
        //original amount due before discount
        $original_amount = $total_amount + $discount;
        //amount due
        echo "<p class='total_amount' style='color:#000'>Amount due: ₦".number_format($original_amount, 2)."</p>";
        //check if payment mode is multiple
        ...
        if($multis > 1){
            ...
            foreach($rows as $row){
                ...
                $balance = $amount_due - $amount_paid;
                if($discount != 0){
                    echo "<p class='total_amount' style='color:#222'>Total Discount: ₦".number_format($discount, 2)."</p>";
    ...
    <p><strong>www.by247.ng</strong></p>
    <p><strong>Items bought cannot be returned!</strong></p>
