...
<div class="displays allResults new_data" id="revenue_report" style="width:60%">
    ...
    <?php
        ...
        foreach($amounts as $amount){
            ...
            echo "<p class='total_amount' style='background:var(--tertiaryColor); color:#fff; text-decoration:none; padding:10px; width:30%; float:right'>Gross Profit: ₦".number_format($total_profit, 2)."</p>";
        }
    ?>
    
</div>
<div class="category_info allResults" id="cat_info">
