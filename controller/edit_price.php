<?php
    ...
    // $store_name = $strs->store;
        ...
        $change_price->update_six('items', 'cost_price', $cost_price, 'sales_price', $sales_price, 'pack_price', $pack_price, 'pack_size', $pack_size, 'wholesale', 0, 'markup', $discount,  'item_id', $item);
