<?php
    ...
    <div class="results">
        <a href="javascript:void(0)"  onclick="addItemToTransfer('<?php echo $row->item_id?>', '<?php echo $row->item_name?>', '<?php echo $quantity?>')"><?php echo $row->item_name." (Quantity => ".$quantity.")"?></a>
    </div>
