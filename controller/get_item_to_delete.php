<?php
    ...
    ?>
    <div class="results">
        <a href="javascript:void(0)"  onclick="deleteItem('<?php echo $row->item_id?>')"><?php echo $row->item_name." (Quantity => ".$quantity.")"?></a>
    </div>
    <!-- <option onclick="deleteItem('<?php echo $row->item_id?>')">
