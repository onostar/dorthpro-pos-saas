<?php
    ...
    $wals = $get_wallet->fetch_details_group('customers', 'wallet_balance', 'customer_id', $customer);
    $wallet = $wals->wallet_balance;
    ...
    <table id="addsales_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="color:red;font-size:.8rem">
                    <span style="font-size:1rem; margin:0 2px"><?php echo $detail->quantity?></span>
                    <a style="color:#fff; background:green;border-radius:5px;padding:5px 8px;" href="javascript:void(0)" title="increase quantity" onclick="increaseQtyWholesale('<?php echo $detail->sales_id?>', '<?php echo $detail->item?>')"><i class="fas fa-arrow-up"></i></a>
                    <a style="color:#fff; background:var(--primaryColor);border-radius:5px;padding:5px 8px;" href="javascript:void(0)" title="decrease quantity" onclick="reduceQtyWholesale('<?php echo $detail->sales_id?>')"><i class="fas fa-arrow-down"></i></a>
                    <a style="color:#fff; background:var(--otherColor);border-radius:5px;padding:5px 8px;" href="javascript:void(0)" title="show more options" onclick="showMoreWholesale('<?php echo $detail->sales_id?>')"><i class="fas fa-pen"></i></a>
                    <a style="color:#fff; background:var(--secondaryColor);border-radius:5px;padding:5px 8px;" href="javascript:void(0)" title="sell item in pack" onclick="getWholesalePack('<?php echo $detail->sales_id?>')"><i class="fas fa-box-open"></i></a>
    ...
    <div class="close_stockin add_user_form" style="width:50%; margin:0;">
        <section class="addUserForm">
            <div class="inputs" style="display:flex;flex-wrap:wrap">
                ...
                <div class="data" id="dep_mode">
                    <label for="dep_mode">Select Deposit Mode</label>
