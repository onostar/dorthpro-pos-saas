...
?>
<div id="reverse_dep" class="displays management" style="margin:10px 0!important; width:100%!important">
<div class="displays allResults new_data" id="revenue_report">
    <h2>Expenses posted today</h2>
    <hr>
    <div class="search">
   ...
   <table id="data_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a style="color:#fff;background:var(--secondaryColor); padding:5px; border-radius:5px" href="javaScript:void(0)" title="Reverse customer deposit" onclick="reverseXpense('<?php echo $detail->expense_id?>')"><i class="fas fa-arrow-left-rotate"></i></a>
                </td>
            </tr>
            <?php $n++; endforeach;}?>
        </tbody>
    ...
    <?php
        ...
        $amounts = $get_total->fetch_sum_curdateCon('expenses', 'amount', 'post_date', 'store', $store);
