    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a style="color:#fff;background:var(--primaryColor); padding:5px; border-radius:10px; box-shadow:1px 1px 1px #222; border:1px solid #fff" href="javascript:void(0)" title="View invoice details" onclick="showPage('debt_details.php?customer=<?php echo $detail->customer?>')">View <i class="fas fa-eye"></i></a>
                </td>
