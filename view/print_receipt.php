    ...
    <table id="revenue_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_curdateGro1conOrder('payments', 'date(post_date)', 'store', $store, 'invoice', 'post_date');
            ...
            <tr>
                ...
                <td><button style="box-shadow:1px 1px 1px #222;border-radius:10px; background:#c4c4c4; color:#000; padding:5px;border:1px solid #fff" title="Print receipt" onclick="printReceipt('<?php echo $detail->invoice?>');"><i class="fas fa-print"></i> Print</button></td>
            </tr>
            <?php $n++; endforeach;}?>
        </tbody>
    </table>
