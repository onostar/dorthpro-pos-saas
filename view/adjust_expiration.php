...
?>
    ...
    <div class="displays allResults" style="width:80%;">
        <h2>Adjust item expiration</h2>
        <hr>
        
            <section class="addUserForm">
                <div class="add_user_form" style="width:50%; margin:10px 0; box-shadow:none">
                    <h3 style="background:var(--otherColor); color:#fff; text-align:left!important;" >Adjust expiration date </h3>
                    <div class="inputs">
                        <!-- bar items form -->
                        <div class="data" id="bar_items" style="width:100%; margin:2px 0">
                            <!-- <label for="item"> Search Items</label> -->
                            <input type="text" name="item" id="item" required placeholder="Search item" onkeyup="checkOtherItems(this.value, getItemDetails, 'get_item_expiration.php')">
                            <div id="sales_item">
