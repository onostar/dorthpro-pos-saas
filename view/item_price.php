            ...
            ?>
                <tr>
                    ...
                    <td class="prices">
                        ...
                        <a style="background:var(--moreColor)!important; color:#fff!important; padding:5px 8px; border-radius:5px;" href="javascript:void(0)" title="modify price" data-form="check<?php echo $row->item_id?>" class="each_prices" onclick="showPage('edit_price_form.php?item=<?php echo $row->item_id?>');"><i class="fas fa-pen"></i></a>
                    </td>
                </tr>
            <?php $n++; endforeach; }?>
                ...
                <div class="add_user_form" style="width:50%; margin:10px 0; box-shadow:none">
                    ...
                    <div class="inputs">
                        ...
                        <div class="data" id="bar_items" style="width:100%; margin:2px 0">
                            ...
                            <input type="text" name="item" id="item" required placeholder="Search item name or barcode" onkeyup="checkOtherItems(this.value, getItemDetails, 'get_items_price.php')" autofocus>
                            <div id="sales_item">
