        ...
        <section class="addUserForm" style="text-align:left!important;">
            <div class="inputs" style="flex-wrap:wrap;gap:.8rem 1.2rem;justify-content:start;">
                ...
                <div class="data" style="width:21%; margin:5px;">
                    ...
                    <!-- <input type="hidden" name="cost_price" id="cost_price" value="<?php echo $row->cost_price?>">
                    <input type="hidden" name="sales_price" id="sales_price" value="<?php echo $row->sales_price?>"> -->
                <div class="data" style="width:21%; margin:5px;">
               ...
               <!--  <div class="data" style="width:21%; margin:5px;">
                ...
                <div class="data" style="width:21%; margin:5px;">
                    ...
                    <!-- <input type="hidden" name="expiration_date" id="expiration_date" value="2028-12-30"> -->
