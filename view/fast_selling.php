...
<div class="displays allResults new_data" id="revenue_report" style="width:80%!important; margin:0 50px!important">
    <h2>Today's Most Sold items (Quantity)</h2>
    <hr>
    <div class="search">
        <input type="search" id="searchCheckout" placeholder="Enter keyword" onkeyup="searchData(this.value)">
        <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('data_table', 'Most Sold items')"title="Download to excel"><i class="fas fa-file-excel"></i></a>
    </div>
