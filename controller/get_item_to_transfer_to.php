<?php
    ...
    $item = htmlspecialchars(stripslashes($_POST['item_to']));
    ...
    <div class="results">
        <a href="javascript:void(0)"  onclick="addItemToTransferTo('<?php echo $row->item_id?>', '<?php echo $row->item_name?>')"><?php echo $row->item_name." (Quantity => ".$quantity.")"?></a>
    </div>
