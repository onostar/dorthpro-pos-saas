<?php
    ...
    include "../classes/update.php";
       ...
       $update_data->update_quadruple('customers', 'customer', $customer, 'phone_numbers',$phone, 'customer_address', $address, 'customer_email', $email, /* 'store', $store, */ 'customer_id', $customer_id);
       if($update_data){
