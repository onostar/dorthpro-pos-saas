...
<div class="displays allResults new_data" id="revenue_report">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php
                        //get customer
                        $cus = $get_users->fetch_details_cond('customers', 'customer_id', $detail->customer);
                        if(is_array($cus)){
                            foreach($cus as $cu){
    ...
    <?php
        ...
        $amounts = $get_total->fetch_sum_curdate2Con('sales', 'total_amount', 'post_date', 'sales_status', 2, 'store', $store);
